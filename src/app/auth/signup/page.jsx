        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-zinc-300 font-medium text-xs pl-0.5">Role</span>
              <div className="flex gap-6 items-center pt-1">
                ...
                >
                  <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center transition-all ${role === 'jobseeker' ? 'border-blue-500 bg-blue-500' : 'border-zinc-500 group-hover:border-zinc-400'}`}>
                    {role === 'jobseeker' && (
                      <div className="w-1.5 h-1.5 rounded-full bg-white" />
                    )}
                  </div>
                  <span className={`text-sm font-medium transition-colors ${role === 'jobseeker' ? 'text-white' : 'text-zinc-400'}`}>
                    Job Seeker
                  </span>
                </div>
                ...
                <div 
                  ...
                  className="flex items-center gap-2 cursor-pointer select-none group"
                >
                  <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center transition-all ${role === 'recruiter' ? 'border-blue-500 bg-blue-500' : 'border-zinc-500 group-hover:border-zinc-400'}`}>
                    {role === 'recruiter' && (
                      <div className="w-1.5 h-1.5 rounded-full bg-white" />
                    )}
                  </div>
                  <span className={`text-sm font-medium transition-colors ${role === 'recruiter' ? 'text-white' : 'text-zinc-400'}`}>
                    Recruiter
                  </span>
                </div>
              </div>
